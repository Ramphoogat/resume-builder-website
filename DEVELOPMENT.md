...
```bash
git remote add encore encore://resume-builder-website-wksi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/resume-builder-website-wksi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/resume-builder-website-wksi/settings/integrations/github)
